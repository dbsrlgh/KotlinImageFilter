package com.example.kotlinimagefilter.Utils
...
object BitmapUtils {
    ...
    fun getBitmapFromGallery(context: Context, path: Uri, width: Int, height: Int):Bitmap{
        val filePathColumn=arrayOf(MediaStore.Images.Media.DATA) //_ID is instead of DATA
    ...
    fun storeThumbnail(contentResolver: ContentResolver, source: Bitmap?, id: Long, width: Float, height: Float, microKind: Int):Bitmap? {
        val matrix = Matrix()
